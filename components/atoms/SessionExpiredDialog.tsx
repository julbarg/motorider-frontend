...
export const SessionExpiredDialog: React.FC<SessionExpiredDialogProps> = (props) => {
  return (
    <Dialog disableEscapeKeyDown={true} onClose={props.onClick} open={true}>
      ...
      <DialogContent>
        <DialogContentText id="alert-dialog-description">Sign In to continue</DialogContentText>
      </DialogContent>
      <DialogActions>
